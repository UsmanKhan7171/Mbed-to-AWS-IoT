...
#define MBED_CONF_APP_LED_OFF                                                 1                                                                                                // set by application[K64F]
#define MBED_CONF_APP_LED_ON                                                  0                                                                                                // set by application[K64F]
#define MBED_CONF_APP_LED_PIN                                                 LED3                                                                                             // set by application[K64F]
#define MBED_CONF_APP_MAIN_STACK_SIZE                                         4096                                                                                             // set by application
#define MBED_CONF_APP_USER_BUTTON                                             BUTTON1                                                                                          // set by application[K64F]
